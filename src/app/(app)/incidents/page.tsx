  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-gray-300">Report and manage safety incidents</p>
      </div>
      <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-white">Incident Log</h2>
          <button className="rounded-lg bg-orange-500 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-600">+ Report Incident</button>
        </div>
